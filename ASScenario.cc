...
// CONFIG PARAMS
  ...
  uint16_t NenbNode = 1;    // NUMBER OF ENBS (MIN = PLMNS)
...
// FIXED PARAM
  ...
  int cpe = NenbConnections / NenbNode;
  int cpo = NenbConnections / plmns;
  int upe = NueNode / NenbNode;
  int rpo = remotehosts / plmns;
  int upo = NueNode / plmns;
  int upr = NueNode / remotehosts;
